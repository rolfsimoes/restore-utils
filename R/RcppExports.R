...
context_cleaner <- function(x, ncols, nrows, band, window_size, target_class, mode_class) {
    .Call(`_restoreutils_context_cleaner`, x, ncols, nrows, band, window_size, target_class, mode_class)
}
